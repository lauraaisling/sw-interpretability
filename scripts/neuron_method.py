...
if not os.path.exists(f'{SAVEFOLD}outputs/neurons/'):
    os.mkdir(f'{SAVEFOLD}outputs/neurons/')

if not os.path.exists(f'{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/'):
    os.mkdir(f'{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}')
...
for direction in range(args.min, args.max):
    ...
    # in this case direction is neuron direction
    ...
    step_1_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/dir_{direction}_step_1_max_projs.png"
    ...
    # get dendrogram
    step_2_linkage_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/dir_{direction}_step_2_linkage.png"
    ...
    step_2_cluster_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/dir_{direction}_step_2_agg_clusters.png"
    ...
    step_3_kmeans_raw_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/dir_{direction}_step_3_kmeans_raw.png"
    ...
    step_3_kmeans_rm_outliers_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/dir_{direction}_step_3_kmeans_rm_outliers.png"
    ...
    step_3_cosine_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/dir_{direction}_step_3_kmeans_rm_outliers.png"
    ...
    if list(clu_labs_rm_outliers).count(100) == top:
        ...
        step_3_UMAP_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/dir_{direction}_step_3_UMAP.png"
    ...
    for concept in range(len(concept_vecs)):
        ...
        step_4_projections_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/dir_{direction}_step_4_projection_{concept}.png"
...
concepts_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/concepts_{args.min}-{args.max-1}.json"  
with open(concepts_f, 'w') as json_file:
    json.dump(concepts, json_file) 

similarities_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/similarities_{args.min}-{args.max-1}.json"  
with open(similarities_f, 'w') as json_file:
    json.dump(concept_sims, json_file)

agg_clusters_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/agg_clusters_{args.min}-{args.max-1}.txt"     
with open(agg_clusters_f, 'w') as fp:
    fp.write(''.join(str(item)+ "\n" for item in agg_clusters))

final_clusters_f = f"{SAVEFOLD}outputs/neurons/{str(args.min)}_{str(args.max-1)}/final_clusters_{args.min}-{args.max-1}.txt"     
